...
def main():
    ...
    pretrained = 'hfl/chinese-electra-180g-'+args.model_type+'-discriminator'
    ...
    # temp_state_dict = torch.load('check_points/exc_c3/electra-exc-2-16-large-drp0.1-wp1-loss2/model_best.pt')
    # state_dict={}
    ...
    if args.do_eval:
        ...
        feature_dir = os.path.join(
            args.data_dir, 'mask_dev_features{}.pkl'.format(args.max_seq_length))
    ...
    if args.do_train:
        ...
        feature_dir = os.path.join(
            args.data_dir, 'mask_train_features{}.pkl'.format(args.max_seq_length))
        if os.path.exists(feature_dir):
    ...
    if args.do_eval:
        ...
        feature_dir = os.path.join(
            args.data_dir, 'mask_test_features{}.pkl'.format(args.max_seq_length))
        if os.path.exists(feature_dir):
